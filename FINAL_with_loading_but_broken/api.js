    ...
    document.addEventListener('sectionChange', async function() {
		...
		switch(step){
			...
			case 2: //--- GET FORM INFORMARTION ---//
					...
					document.getElementById('img_Obj_1').display = "none";
					//--- CHAT GPT REQUEST ---//
					messages = [
					...
					document.getElementById("loading2pic").style.visibility = "visible";
					...
					image_url_Ob1 = response1.data.data[0].url;
					document.getElementById("loading2pic").style.visibility = "hidden";
					document.getElementById("loading2pic").style.display = "none";
					document.getElementById('img_Obj_1').display = "flex";
			...
			case 4: //--- GET FORM INFORMARTION ---//
					...
					document.getElementById('img_Obj_1_3').src = image_url_Ob1;
					document.getElementById('img_Obj_2').display = "none";
					//--- CHAT GPT REQUEST ---//
					messages = [
						{role: "system", content: 	"Du hilfst mir einen negativen Tagebucheintrag über " + promptName2 + " zu ergänzen. "},
						{role: "user", content: "Der alte Text: " + oldText},
					...
					document.getElementById("loading3pic").style.visibility = "visible";
					...
					image_url_Ob2 = response2.data.data[0].url;

					document.getElementById("loading3pic").style.visibility = "hidden";
					document.getElementById("loading3pic").style.display = "none";
					document.getElementById('img_Obj_1').display = "flex";
					document.getElementById('img_Obj_2').src = image_url_Ob2; 
			break;
			...
			case 6: //--- GET FORM INFORMARTION ---//
					...
					document.getElementById('img_Obj_1_4').src = image_url_Ob1;
					document.getElementById('img_Obj_2_4').src = image_url_Ob2;
					document.getElementById('loading4pic').display = "none";
					...
					document.getElementById('img_Obj_2_4').style.display = "none";
					document.getElementById("loading4pic").style.display = "flex";
					...
					image_url_Ob3 = response3.data.data[0].url;
					document.getElementById("loading4pic").style.visibility = "hidden";
					document.getElementById("loading4pic").style.display = "none";
					document.getElementById('img_Obj_2_4').style.display = "flex";
					document.getElementById('img_Obj_2_4').src = image_url_Ob3; 
			break;
			...
			case 8: //--- GET FORM INFORMARTION ---//
					...
					document.getElementById('img_Obj_1_5').src = image_url_Ob1;
					document.getElementById('img_Obj_2_5').src = image_url_Ob3;
					document.getElementById('loading5pic').display = "none";
					...
					document.getElementById('img_Obj_1_5').style.display = "none";
					document.getElementById("loading5pic").style.display = "flex";
					...
					image_url_Ob4 = response4.data.data[0].url;
					document.getElementById("loading5pic").style.visibility = "hidden";
					document.getElementById("loading5pic").style.display = "none";
					document.getElementById('img_Obj_1_5').style.display = "flex";
